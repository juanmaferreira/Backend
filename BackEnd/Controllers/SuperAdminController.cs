    ...
    public class SuperAdminController : ControllerBase
    {
        ...
        public void meterDatos()
        {
            try
            {
                ...
                cadena = "insert into participantes(nombre,Area) values ('Participante2', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre,Area) values ('Participante3', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante4', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante5', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante6', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante7', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante8', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante9', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante10', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante11', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante12', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante13', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante14', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante15', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into participantes(nombre, Area) values ('Participante16', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                ...
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo1', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo2', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo3', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo4', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo5', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo6', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo7', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo8', 0)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo9', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo10', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo11', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo12', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo13', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo14', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo15', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo16', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo17', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo18', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo19', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo20', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo21', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo22', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo23', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo24', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo25', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo26', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo27', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo28', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo29', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo30', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo31', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Equipos(nombreEquipo, deporte) values ('Equipo32', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
