    ...
    public class SuperAdminController : ControllerBase
    {
        ...
        public void meterDatos()
        {
            ...
            //{
                ...
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Competencias(Area, fecha_competencia, nombre, ligaI, topeParticipantes, Liga_IndividualId, activa) values (1, '2022-10-06', 'Competencia1', 0, 3, NULL, true)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Nombres(nombre, competenciaId) values ('Competencia1', 1)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Competencias(Area, fecha_competencia, nombre, ligaI, topeParticipantes, Liga_IndividualId, activa) values (1, '2022-10-06', 'Competencia2', 0, 3, NULL, true)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Nombres(nombre, competenciaId) values ('Competencia2', 2)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Competencias(Area, fecha_competencia, nombre, ligaI, topeParticipantes, Liga_IndividualId, activa) values (2, '2022-10-06', 'Competencia3', 0, 5, NULL,true)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Nombres(nombre, competenciaId) values ('Competencia3', 3)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Competencias(Area, fecha_competencia, nombre, ligaI, topeParticipantes, Liga_IndividualId,activa) values (2, '2022-10-06', 'Competencia4', 0, 8, NULL,true)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Nombres(nombre, competenciaId) values ('Competencia4', 4)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Competencias(Area, fecha_competencia, nombre, ligaI, topeParticipantes, Liga_IndividualId,activa) values (3, '2022-10-06', 'Competencia5', 0, 3, NULL, true)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Nombres(nombre, competenciaId) values ('Competencia5', 5)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
                cadena = "insert into Competencias(Area, fecha_competencia, nombre, ligaI, topeParticipantes, Liga_IndividualId,activa) values (3, '2022-10-06', 'Competencia6', 0, 4, NULL,true)";
                comando = new SqlCommand(cadena, conexion);
                comando.ExecuteNonQuery();
